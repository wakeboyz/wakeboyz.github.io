...
/***/ function(module, exports, __webpack_require__) {
	...
	var _person = __webpack_require__(157);
	
	var _person2 = _interopRequireDefault(_person);
	
	var _goose = __webpack_require__(158);
	
	var _goose2 = _interopRequireDefault(_goose);
	
	var _gooseTally = __webpack_require__(159);
	
	var _gooseTally2 = _interopRequireDefault(_gooseTally);
	...
	var ShowCase = _react2["default"].createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			if (window.webkitSpeechRecognition) {
				var recognizeSpeech = new webkitSpeechRecognition();
				recognizeSpeech.continuous = true;
				recognizeSpeech.lang = "en-US";
				recognizeSpeech.start();
				recognizeSpeech.onresult = function (e) {
					var resultsLength = e.results.length;
					var recognizedSpeech = e.results[resultsLength - 1][0].transcript;
					var isGoose = recognizedSpeech === "goose";
					if (isGoose) {
						_this.setState({ gooseOn: true });
					}
				};
			}
		},
	
		toggleGoose: function toggleGoose() {
			this.setState({
		...
		render: function render() {
			var people = this.state.people.map(function (person) {
				return _react2["default"].createElement(_person2["default"], _extends({ key: person.name }, person));
			});
			var goose = _react2["default"].createElement(_goose2["default"], null);
			...
			return _react2["default"].createElement(
				"div",
				null,
				_react2["default"].createElement("div", { style: { color: "#000000", backgroundImage: "url(./images/wf.png)", width: "200px", height: "140px", display: "inline-block" } }),
				_react2["default"].createElement(
					"div",
					{ style: { color: "#000000", fontFamily: "'Yellowtail', cursive", fontSize: "50px", display: "inline-block" } },
					"Wake Boyz Fantasy Football League"
				),
				_react2["default"].createElement("div", { onClick: this.toggleGoose, style: { cursor: "pointer", color: "#000000", backgroundImage: "url(./images/goose.png)", width: "100px", height: "131px", display: "inline-block" } }),
				_react2["default"].createElement(
					"div",
					{ style: { display: "flex" } },
					_react2["default"].createElement(
						"div",
						{ style: { display: "flex", flexWrap: "wrap", marginLeft: "auto", backgroundColor: "#9E7E38", width: "100%" } },
						renderItem
					)
				)
			);
	...
	_react2["default"].render(_react2["default"].createElement(ShowCase, null), document.getElementById("app"));
		...
		render: function render() {
			...
			if (this.state.hovered && !this.props.removed) {
				...
				tagline = _react2["default"].createElement(
					"div",
					{ style: { color: "#9E7E38", fontWeight: 600, textShadow: "3px 3px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000", fontFamily: "'Open Sans', sans-serif", paddingTop: "20%" } },
					this.props.tagline
				);
				...
				tagline = _react2["default"].createElement(
					"div",
					{ style: { color: "#9E7E38", fontWeight: 800, fontSize: 315, position: "relative", bottom: 100, textShadow: "3px 3px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000", fontFamily: "'Open Sans', sans-serif" } },
					"X"
				);
			}
			...
			return _react2["default"].createElement(
				"span",
				{ style: { width: "255px", height: "255px", padding: "20px" }, onMouseEnter: this.toggleHover, onMouseLeave: this.toggleHover },
				image
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var goose;
	var Goose = _react2["default"].createClass({
		displayName: "Goose",
		...
		randomGoosePosition: function randomGoosePosition() {
		...
		render: function render() {
			...
			return _react2["default"].createElement(
				"div",
				null,
				_react2["default"].createElement("img", { src: "./images/run_goose.png", style: (_ref = { position: "absolute" }, _defineProperty(_ref, this.state.vertDirection, this.state.vert), _defineProperty(_ref, this.state.horDirection, this.state.hor), _ref) }),
				_react2["default"].createElement(
					"audio",
					{ autoPlay: true },
					_react2["default"].createElement("source", { src: "./audio/benny.mp3", type: "audio/mpeg" })
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GooseTally = _react2["default"].createClass({
		displayName: "GooseTally",
	
		render: function render() {
			var tally = this.props.geese.map(function (goose) {
				var geeseImages = [];
				for (var i = 0; i < goose.total; i++) {
					geeseImages.push(_react2["default"].createElement("img", { style: { height: "100px" }, src: "./images/goose.png" }));
				}
				return _react2["default"].createElement(
					"div",
					{ key: goose.name, style: { fontWeight: 600, fontSize: "45px", fontFamily: "'Yellowtail', cursive" } },
					_react2["default"].createElement(
						"div",
						null,
						goose.name
	...
	exports["default"] = GooseTally;
	module.exports = exports["default"];

/***/ }
/******/ ]);
//# sourceMappingURL=wfu.js.map