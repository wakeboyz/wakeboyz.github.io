      ...
      people: [
        {
          name: "Conor",
          tagline:
            "Human cat who enjoys playing with yarn, pizza, and demonstrating flexibility.",
          initImage: "conor.png",
        ...
        },
        {
          name: "Gabe",
          tagline:
            "Picked up a law degree in order to stay in the US legally. Come Back To Macon",
          initImage: "gabe.png",
        ...
        },
        {
          name: "Joe",
          tagline:
            "A reminder that, despite all odds, a last name and not being fat can get you far in life. ",
          initImage: "joe.png",
        ...
        },
        {
          name: "Bryan",
          tagline:
            "Tinder pundit and passive aggressive tweeter. RI was unavailable to join the fantasy league.",
          initImage: "bryan.png",
        ...
        },
        {
          name: "Brad",
          tagline:
            "The inventor of the swirl, this young Clevelander loves Paul Blart, frisbee, and dates out of his league.",
          initImage: "brad.png",
        ...
        },
        {
          name: "Josh",
          tagline:
            "Desert fox, hurricane creator, and destroyer of dance floors.",
          initImage: "josh.png",
        ...
        },
        {
          name: "Bert",
          tagline:
            "Has spent the last two years of his life acting out Lonely Island's I Just Had Sex video.",
          initImage: "bert.png",
  ...
  render: function() {
    ...
    return (
      <div>
        ...
        <div
          onClick={this.toggleGoose}
          style={{
            cursor: "pointer",
            color: "#000000",
            backgroundImage: "url(./images/goose.png)",
            width: "100px",
            height: "131px",
            display: "inline-block"
          }}
